...
"[externals]/ [external] (@aws-sdk/client-s3, cjs)": (function(__turbopack_context__) {
...
"[externals]/ [external] (firebase-admin/auth, esm_import)": ((__turbopack_context__) => {
"use strict";
...
const mod = await __turbopack_external_import__("firebase-admin/auth");

__turbopack_export_namespace__(mod);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, true);}),
"[externals]/ [external] (firebase-admin/firestore, esm_import)": ((__turbopack_context__) => {
"use strict";
...
"[externals]/ [external] (firebase-admin/app, esm_import)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/s3/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$firebase$2d$admin$2f$auth$2c$__esm_import$29$__,
    __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__,
    __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$29$__
]);
([__TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$firebase$2d$admin$2f$auth$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$firebase$2d$admin$2f$app$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
async function GET(request) {
    ...
    try {
        ...
        const folderPromises = (response.CommonPrefixes || []).map(async (prefix)=>{
            ...
            const yearContents = await s3Client.send(new __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$2840$aws$2d$sdk$2f$client$2d$s3$2c$__cjs$29$__["ListObjectsV2Command"]({
                Bucket: process.env.AWS_S3_BUCKET,
                Prefix: prefix.Prefix,
                Delimiter: ''
            }));
            const images = yearContents.Contents?.filter((item)=>item.Key?.toLowerCase().match(/\.(jpg|jpeg|png|gif)$/i)).map((item)=>item.Key) || [];
            ...
            if (images.length > 0) {
                ...
                if (randomImageKey) {
                    ...
                    backgroundUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$s3$2d$request$2d$presigner$2f$dist$2d$es$2f$getSignedUrl$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSignedUrl"])(s3Client, getObjectCommand, {
        ...
        const folders = (await Promise.all(folderPromises)).filter((folder)=>folder !== null).sort((a, b)=>parseInt(a.name) - parseInt(b.name));
        console.log('\nFinal folders data:', folders.map((f)=>({
                name: f?.name,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4277a6._.js.map